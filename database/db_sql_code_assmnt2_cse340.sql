-- ASSIGNMENT 2, WEEK 2, WINTER CSE340 2ND BLOCK 2024 RUNE LARSEN
--TASK 1 CREATE TYPE
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public.account_type OWNER TO theonlyrune;
-- Task 2 Create inventory table
...
--Task 6 insert data into  classification
